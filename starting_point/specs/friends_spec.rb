...
class TestFriends < MiniTest::Test
  ...
  def test_return_fav_tv_show
    result = return_fav_tv_show(@person5)
  ...
  def test_likes_food_spinach
    result = likes_food(@person5, "spinach")
    assert_equal(true, result)
  end

  def test_likes_apple
    result = likes_food(@person5, "apple")
...
def test_add_friend
  ...
  #what if the lender has less than the amount
  def test_lend_money
    result = lend_money(@person5, @person4, 10)
